...
function HelmetMetaData(props) {
    ...
    let description = props.description !== undefined ? props.description : "Queremos que o prefeito de Campinas Dario Saadi leve a campanha de vacinação contra a Covid-19 a todos os Centros de Saúde da cidade. Não concordamos que os idosos e seus acompanhantes tenham que se deslocar quilômetros de suas casas até um dos cinco pontos de vacinação definidos pela Prefeitura. Assine já.";
    let hashtag = props.hashtag !== undefined ? props.hashtag : "#descentralizavacina";
    return (
        <Helmet>
            <title>{title}</title>
            <meta charset="utf-8" />
